...
(function (root) {
    ...
    function addJqueryFunct() {
        ...
        function decodeURI(key, optionsToUse) {
            try {
                return decodeURIComponent(escape($.t(key, optionsToUse)));
            } catch (e) {
                return $.t(key, optionsToUse);
            }
        }
        ...
        function parse(ele, key, options) {
            ...
            if (attr === 'html') {
                ...
                ele.text(decodeURI(key, optionsToUse));
            } else if (attr === 'prepend') {
                optionsToUse = o.defaultValueFromContent ? $.extend({defaultValue: ele.html()}, options) : options;
                ele.prepend(decodeURI(key, optionsToUse));
            } else if (attr === 'append') {
                optionsToUse = o.defaultValueFromContent ? $.extend({defaultValue: ele.html()}, options) : options;
                ele.append(decodeURI(key, optionsToUse));
            } else if (attr.indexOf("data-") === 0) {
                var dataAttr = attr.substr(("data-").length);
                optionsToUse = o.defaultValueFromContent ? $.extend({defaultValue: ele.data(dataAttr)}, options) : options;
                var translated = decodeURI(key, optionsToUse);
                ...
                ele.attr(attr, decodeURI(key, optionsToUse));
            }
        }
