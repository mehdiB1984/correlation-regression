...
/**
 * Geometric discrete distribution chart class
 *
 ...
 * @returns {DistGeometricChart}
 * @constructor
 *
 * Created by Jose David Jurado Alonso <i22jualj@uco.es> on 07/15
 */
function DistGeometricChart($container, grid, xMax, yMax, dataDistribution, dataProbability) {
    ...
    var options = {
        ...
        title: {
            text: Texts.decodeURIComponent("dd.charts.geometric")
        },
     ...
     * @param p The p value
     */
    this.updateSubtitle = function (p) {
        chart.setTitle(null, {text: "g( " + p + " )"});
    };
...
/**
 * Geometric discrete distribution handler class
 *
 * @param pValue  Distribution 'p' parameter value
 * @param endValue The end or max value to calculate all data
 * @returns {DistGeometric}
 * @constructor
 *
 * Created by Jose David Jurado Alonso <i22jualj@uco.es> on 07/15
 */
function DistGeometric(pValue, endValue) {
